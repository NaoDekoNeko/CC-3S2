...
```
# Tu respuesta
una lista vacía podría ser un caso de prueba límite, ie: 
valores = []
pues sería el mínimo de elementos que se tiene en cuenta en una lista.
una lista con 10 elementos también, eg: 
valores = [9, 8, 7, 6, 5, 4, 3, 2, 1, 0]
pues sería el mínimo a tener en cuenta  por la sentencia else if
```
...
Pones salsa y aderezos en una corteza y la horneas, para ver si la corteza todavía se cocina bien con las cosas húmedas encima. Esto es `integration`.
