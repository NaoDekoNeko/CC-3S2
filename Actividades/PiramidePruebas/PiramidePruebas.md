...
`Prueba de sistema -> Falacia de ausencia de errores` 
...
`Pruebas tempranas o también pruebas de sistema`
...
`Se debe realizar test conforme se agreguen funcionalidades. Supongamos también que es dificil encontrar los elementos html, habrá que hacerlos facilmente detectable`
