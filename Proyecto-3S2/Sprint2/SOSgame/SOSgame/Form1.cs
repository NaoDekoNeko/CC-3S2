...
namespace SOSgame
{
    public partial class Form1 : Form
    {
        ...
        {
            int tamanio = (int)numericUpDown1.Value;
            Tamanio_Tablero t = new Tamanio_Tablero();
            t.Asignar_Tamanio(tamanio, tableLayoutPanel1);
        }
        public void Asignar_S_O(object sender, EventArgs e)
        {
